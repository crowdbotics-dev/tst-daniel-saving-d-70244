...
const AddressScreen = ({
  ...
  return <ScrollView style={[styles.container]} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.searchContainer}>
        ...
        <View style={[styles.inputText, styles.jmoZTrWu]}>
          <View style={styles.kuKNRXiv}>
      ...
      {userAddresses && userAddresses.map((address, index) => <View style={styles.searchContainer} key={index}>
            <Text style={styles.lHKXBkbq}></Text>
            <Pressable style={styles.addressContainer} onPress={() => updateCurrentAddress(address)}>
              <View style={styles.yRwCRzPg}>
      ...
      <Button buttonText={"Update"} onPress={() => navigation.navigate("checkoutScreen", {
      currentAddress
    })} />
    </ScrollView>;
};
...
export const Input = props => {
  return <View>
      <TextInput style={textStyles.input} placeholder={props.placeholder} value={props.value} onChangeText={num => props.onChangeText(num)} placeholderTextColor='#000000' editable={props.editable !== false} />
...
const Button = props => {
  return <TouchableHighlight onPress={props.onPress} underlayColor='#DDDDDD' style={btnStyles.mainContainer}>
