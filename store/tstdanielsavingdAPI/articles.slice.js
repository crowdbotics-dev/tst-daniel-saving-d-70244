...
export const modules_articles_article_list = createAsyncThunk("articles/modules_articles_article_list", async payload => {
  const response = await apiService.modules_articles_article_list(payload);
  return response.data;
});
export const modules_articles_article_create = createAsyncThunk("articles/modules_articles_article_create", async payload => {
  const response = await apiService.modules_articles_article_create(payload);
  return response.data;
});
export const modules_articles_article_retrieve = createAsyncThunk("articles/modules_articles_article_retrieve", async payload => {
  const response = await apiService.modules_articles_article_retrieve(payload);
  return response.data;
});
export const modules_articles_article_update = createAsyncThunk("articles/modules_articles_article_update", async payload => {
  const response = await apiService.modules_articles_article_update(payload);
  return response.data;
});
export const modules_articles_article_partial_update = createAsyncThunk("articles/modules_articles_article_partial_update", async payload => {
  const response = await apiService.modules_articles_article_partial_update(payload);
  return response.data;
});
export const modules_articles_article_destroy = createAsyncThunk("articles/modules_articles_article_destroy", async payload => {
