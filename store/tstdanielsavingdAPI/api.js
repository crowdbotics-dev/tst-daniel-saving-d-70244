...
function modules_articles_article_update(payload) {
  return tstdanielsavingdAPI.put(`/modules/articles/article/${payload.id}/`, payload.data);
}

function modules_articles_article_partial_update(payload) {
  return tstdanielsavingdAPI.patch(`/modules/articles/article/${payload.id}/`, payload.data);
}
...
function rest_auth_password_reset_confirm_create(payload) {
  return tstdanielsavingdAPI.post(`/rest-auth/password/reset/confirm/`, payload.data);
}

function rest_auth_registration_verify_email_create(payload) {
  return tstdanielsavingdAPI.post(`/rest-auth/registration/verify-email/`, payload.data);
}
